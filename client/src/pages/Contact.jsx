  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(response.ok){
        ...
        console.log(data);
        alert("messagge send successfully")
      }
    } catch (error) {
      console.log(error);
    }
          ...
          <section className="section-form">
            <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <textarea name="message" autoComplete='off' required id="message" cols="30" rows="6" value={contact.message} onChange={handleInput}></textarea>
              </div>
